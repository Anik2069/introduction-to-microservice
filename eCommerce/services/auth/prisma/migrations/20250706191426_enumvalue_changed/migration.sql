/*
  ...
  - The values [USEF] on the enum `VerificationStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "VerificationStatus_new" AS ENUM ('PENDING', 'USED', 'EXPIRED');
ALTER TABLE "VerificationCode" ALTER COLUMN "status" DROP DEFAULT;
